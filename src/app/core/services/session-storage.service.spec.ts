...
xdescribe('SessionStorageService', () => {
  ...
  describe('#setItem, #getItem', () => {
    it('should set and get item', () => {
      ...
      const resultUser: User = SessionStorageService.getItem(
  ...
  describe('#removeItem', () => {
    it('should remove item', () => {
      ...
      expect(
        SessionStorageService.getItem(AppConst.STORAGE_KEY_USER, new User())
      ).toBeNull();
    });
  });
});
...
function createUser(): User {
  ...
  user.userTimezoneOffset = 'userAccount';
